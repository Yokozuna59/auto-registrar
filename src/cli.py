...
class Questions:
    ...
    def bool_question(question: str, default: bool = True) -> bool:
        ...
        while not correct_answer:
            stdout.write(
                f"{AnsiEscapeCodes.GREEN}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}{question}?{AnsiEscapeCodes.RESET} {default_answer} "
            )
            ...
            try:
                ...
                stdout.write(
                    f"{AnsiEscapeCodes.FAINT}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}\x1b[38;2;175;175;175m{question}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.RED}Cancelled by user{AnsiEscapeCodes.RESET}{AnsiEscapeCodes.NEW_LINE}"
                )
                exit()
            ...
            if answer == "":
                ...
                if answer == "y" or answer == "yes":
                    ...
                    stdout.write(
                        f'{AnsiEscapeCodes.RED}! Sorry, your reply was invalid:{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}"{answer}"{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.RED}is not a valid answer, please try again.{AnsiEscapeCodes.RESET}{AnsiEscapeCodes.NEW_LINE}'
                    )
    ...
    def str_questoin(question: str) -> str:
        ...
        stdout.write(
            f"{AnsiEscapeCodes.GREEN}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}{question}?{AnsiEscapeCodes.RESET} "
        )
        stdout.write(AnsiEscapeCodes.SAVE_POSITION)
        ...
        stdout.write(AnsiEscapeCodes.ERASE_TO_END_OF_LINE)
        stdout.write(
            f"{AnsiEscapeCodes.BLUE}{answer}{AnsiEscapeCodes.RESET}{AnsiEscapeCodes.NEW_LINE}"
        )
        stdout.flush()
        return answer

    def int_question(
        question: str, minimum: int = -1000000000000000, maximum: int = 1000000000000000
    ) -> int:
        """
            ...
            if answer == "":
                ...
                try:
                    ...
                    if (answer >= minimum) and (answer <= maximum):
                        ...
                        stdout.write(
                            f'{AnsiEscapeCodes.RED}! Sorry, your reply was invalid:{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}"{answer}"{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.RED}is out of range, please try again.{AnsiEscapeCodes.RESET}{AnsiEscapeCodes.NEW_LINE}'
                        )
                except ValueError:
                    stdout.write(
                        f'{AnsiEscapeCodes.RED}! Sorry, your reply was invalid:{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}"{answer}"{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.RED}is not a valid answer, please try again.{AnsiEscapeCodes.RESET}{AnsiEscapeCodes.NEW_LINE}'
    ...
    def passcode_question(question: str) -> str:
        ...
        stdout.write(
            f"{AnsiEscapeCodes.GREEN}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}{question}?{AnsiEscapeCodes.RESET} (Press Esc to make passcode visible) "
        )
        stdout.write(AnsiEscapeCodes.SAVE_POSITION)
    ...
    def list_question(question: str, choices: list) -> str:
        ...
        while not finished:
            ...
            line_gap = (
                ...
                if (question_lines > 36 and question_lines <= terminal_columns)
                else 1
            )
            stdout.write(AnsiEscapeCodes.MOVE_RIGHT * len(word))
            stdout.write(
                f"{AnsiEscapeCodes.BLUE} [Use arrows to move, type to filter]{AnsiEscapeCodes.RESET}"
            )

            if (letter != AnsiEscapeCodes.MOVE_UP) and (
                letter != AnsiEscapeCodes.MOVE_DOWN
            ):
                list_lenght = 0
                choices = []
                ...
                stdout.write(AnsiEscapeCodes.RESTORE_POSITION)
                stdout.write(
                    AnsiEscapeCodes.MOVE_TO_BEGIN_OF_NEXT_LINE
                ) if line_gap == 1 else None
                ...
                for index, choice in enumerate(ALL_CHOICES):
                    if word.lower() in choice.lower():
                        ...
                        if list_lenght == 1:
                            stdout.write(
                                f"{AnsiEscapeCodes.BLUE}> {choice}{AnsiEscapeCodes.RESET}"
                            )
                            answer = choice
                        else:
                            stdout.write(
                                f"{AnsiEscapeCodes.BOLD}  {choice}{AnsiEscapeCodes.RESET}"
                            )
                index = 1
            ...
            if letter == AnsiEscapeCodes.CNTL:
                ...
                if letter == AnsiEscapeCodes.MOVE_UP and list_lenght != 0:
                    stdout.write(
                        AnsiEscapeCodes.MOVE_TO_BEGIN_OF_NEXT_LINE * (index + line_gap)
                    )
                    index -= 1
                    stdout.write(AnsiEscapeCodes.ERASE_ENTIRE_LINE)
                    stdout.write(
                        f"{AnsiEscapeCodes.BOLD}  {choices[index]}{AnsiEscapeCodes.RESET}"
                    )
                    stdout.write(AnsiEscapeCodes.RESTORE_POSITION)
                    if index == 0:
                        index = list_lenght
                    ...
                    stdout.write(AnsiEscapeCodes.ERASE_ENTIRE_LINE)
                    stdout.write(
                        f"{AnsiEscapeCodes.BLUE}> {choices[index - 1]}{AnsiEscapeCodes.RESET}"
                    )
                    ...
                    stdout.write(AnsiEscapeCodes.ERASE_ENTIRE_LINE)
                    stdout.write(
                        f"{AnsiEscapeCodes.BOLD}  {choices[index - 1]}{AnsiEscapeCodes.RESET}"
                    )
                    stdout.write(AnsiEscapeCodes.RESTORE_POSITION)
                ...
                if list_lenght != 0:
                    ...
                    stdout.write(AnsiEscapeCodes.RESTORE_POSITION)
                    stdout.write(
                        f"{AnsiEscapeCodes.BLUE}{answer}{AnsiEscapeCodes.RESET}"
                    )
                    stdout.write(AnsiEscapeCodes.SAVE_POSITION)
                ...
                stdout.write(AnsiEscapeCodes.ERASE_ENTIRE_LINE)
                stdout.write(
                    f"{AnsiEscapeCodes.FAINT}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}\x1b[38;2;175;175;175m{question}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.RED}Cancelled by user{AnsiEscapeCodes.RESET}"
                )
                stdout.write(AnsiEscapeCodes.SAVE_POSITION)
                for _ in choices:
                    stdout.write(AnsiEscapeCodes.MOVE_TO_BEGIN_OF_NEXT_LINE)
    ...
    def mcq_list_question(question: str, choices: list) -> list:
        ...
        stdout.write(AnsiEscapeCodes.HIDE_CURSOR)
        stdout.write(
            f"{AnsiEscapeCodes.LIGHT_GREEN}?{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}{question}{AnsiEscapeCodes.RESET}? {AnsiEscapeCodes.BLUE} (<up> & <down> to move, <space> to select, <a> to toggle){AnsiEscapeCodes.RESET}"
        )
        stdout.write(AnsiEscapeCodes.SAVE_POSITION)
        ...
        for index, choice in enumerate(choices):
            ...
            if index == 0:
                stdout.write(
                    f"{AnsiEscapeCodes.BLUE}>{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BOLD}○{AnsiEscapeCodes.RESET} {AnsiEscapeCodes.BLUE}{choice}{AnsiEscapeCodes.RESET}"
                )
            else:
                stdout.write(
                    f"  {AnsiEscapeCodes.BOLD}○ {choice}{AnsiEscapeCodes.RESET}"
                ...
                if letter == AnsiEscapeCodes.MOVE_UP:
                    ...
                    stdout.write(
                        "  {}{} {}{}".format(
                            ...
                            "●" if choices[index] in answers else "○",
                            choices[index],
                            AnsiEscapeCodes.RESET,
                        )
                    )
                    ...
                    stdout.write(
                        "{}>{} {}{} {}{}".format(
                            ...
                            AnsiEscapeCodes.RESET,
                            AnsiEscapeCodes.LIGHT_BLUE,
                            "●" if choices[index - 1] in answers else "○",
                            choices[index - 1],
                            AnsiEscapeCodes.RESET,
                        )
                    )
...
def print_colorful_text(
    text_string: str, text_color: str, end_with=AnsiEscapeCodes.NEW_LINE
) -> str:
    """
    Print colorful text.\n
...
def progress_bar(total_time: int) -> None:
    ...
    for i in range(1, total_time + 1):
        if current_columns != columns:
            lines = (
                ceil(current_columns / columns)
                if (current_columns > columns)
                else ceil(columns / current_columns)
            )
        ...
        if i == 1:
            ...
            stdout.write(
                "Next Refresh: |{}".format(
                    "█" * (floor(columns * (i / total_time)) - 1)
                )
            )
            stdout.write(
                "{}".format(" " * ceil(columns * (total_time - i) / total_time)) + "|"
                if (columns - i) != 0
                else "|"
            )
        stdout.flush()
...
def time_program_execution(userSeconds: int) -> str:
    ...
    program_execution = "%d days, %02d hours, %02d minutes and %02d seconds" % (
        numberOfDays,
        numberOfHours,
        numberOfMinutes,
        numberOfSeconds,
