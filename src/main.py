...
def main() -> int:
    ...
    while not registrared:
        ...
        registrared = check_for_changes(
            content=courses_requested, search_input=search_input, configs_file=configs
        )
...
if __name__ == "__main__":
    ...
    print_colorful_text(
        text_string="The program has finished in {} seconds.".format(number_of_seconds),
        color=AnsiEscapeCodes.GREEN,
    )
